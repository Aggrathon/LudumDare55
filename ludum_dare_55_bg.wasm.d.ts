...
export function wasm_bindgen__convert__closures__invoke1_mut__h2d4958b288a08146(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h05e178b9332f11ff(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h20f8f98744d6f7dd(a: number, b: number): void;
